...
class Registration extends Component {
 ...
 handleSubmit(event) {
  ...
  try {
    ...
    const response = fetch('https://manraj-ors-1.onrender.com/user', {
      method: 'POST',
     ...
     <div className="container login template d-flex justify-content-center align-items-center 100-w vh-100 bg-secondary">
      <div className="row-justify-container form-container p-5 rounded bg-light">
        ...
        <form>
         ...
         <br /><br />
         <label >password:
         <input  type="text"placeholder='password'  value={this.state.password}  onChange={(event)=>this.setState({password:event.target.value})}/></label>
          <br /><br />
          <label >Rol id:
